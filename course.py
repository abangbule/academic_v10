...
class Course(models.Model):
    ...
    description = fields.Text(string="Description", require="False", )
    ...
    _sql_constraints = [('cek_name_desc', 'CHECK(name <> description)', 
        'Field name dan description tidak boleh sama'), ('cek_unik_name', 'UNIQUE(name)', 'Name harus unik')
    ]